...
<% 
    ...
    try{
        ...
        //This is done through the Context so we will skip this step.
...
<ul>
	<font size="2">
	Yazd successfully connected to your database. Press the "Continue" button to proceed to the next step of
	setup. 
	<p>
