...
<tr height="100%">
	...
	></a><%}
	if ( isSystemAdmin){ %><a href="sidebar.jsp?tree=category" onclick="location.href='header.jsp?tab=category';" target="sidebar"
	><img src="images/tabs_category_<%= (tab.equals("category"))?"on":"off" %>.gif" height="35" alt="" border="0"
