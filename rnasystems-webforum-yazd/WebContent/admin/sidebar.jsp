...
<%@ page language="java" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8" import="com.Yasna.forum.*,
	...
	// treeName is not null so use that variable to get the tree
			...
			(isSystemAdmin || isGroupAdmin) )
		{
			...
			tree = adminBean.getTree("forumTree");
                ...
                else if( treeName.equals("category") && ( isSystemAdmin || isForumAdmin || isModerator ) ) {
			tree = adminBean.getTree("categoryTree");
		}
	}
