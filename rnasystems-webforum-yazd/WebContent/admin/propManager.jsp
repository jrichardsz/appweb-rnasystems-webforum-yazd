...
<input type="hidden" name="propName" value="<%= name %>">
	...
	<td><% if (name.equals("yazdMailBody") || (name.equals("yazdThreadWatch.MailBody")) || (name.equals("yazdActivate.MailBody"))){%>
    <textarea name="propValue" cols="40" rows="3"><%=value%></textarea>
    <%}else{%>
