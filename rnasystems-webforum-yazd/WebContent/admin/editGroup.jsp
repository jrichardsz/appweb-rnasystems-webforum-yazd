...
<%	////////////////////
    ...
    boolean newAutoMember = ParamUtils.getCheckboxParameter(request,"automember");
...
<%	////////////////////////////////////////////////////////////////
	...
	if( !errors && doEdit ) {
		...
		try {
            ...
            thisGroup.setAutoGroupMembership(newAutoMember);
...
<tr bgcolor="#ffffff">
	<td><font size="-1">Automatic Membership:<br>(If turned on, new users will automatically be added to this group)</i></font></td>
	<td>
		<input type="checkbox" name="automember" <%=thisGroup.getAutoGroupMembership()?"checked":""%>>
	</td>
</tr>
