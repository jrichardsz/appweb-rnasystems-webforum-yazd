...
<%	/////////////////////
	...
	// view button
	String viewButtonText = YazdLocale.getLocaleKey("View_topics",locale);
	...
	// post button
	String postButtonText = YazdLocale.getLocaleKey("Post_new_message",locale);
	...
	// reply button
	String replyButtonText = YazdLocale.getLocaleKey("Reply",locale);
	...
	// search button
	String searchButtonText = YazdLocale.getLocaleKey("Search_this_forum",locale);
	...
	// account button
	String accountButtonText = YazdLocale.getLocaleKey("Your_account",locale);
	...
	// Login button
	String loginButtonText = YazdLocale.getLocaleKey("Login",locale);
	...
	// logout button
	String logoutButtonText = YazdLocale.getLocaleKey("Logout",locale);
