...
public class SimpleUploaderServlet extends HttpServlet {
     ...
     */
     public void init() throws ServletException {
        ...
        if(debug) System.out.println("---- Using the directory:"+realBaseDir);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (debug) System.out.println(userdir);
        String realBaseDir=getServletContext().getRealPath(baseDir+userdir);
        File baseFile=new File(realBaseDir);
        if(!baseFile.exists()){
            baseFile.mkdir();
        }
        if (debug) System.out.println(realBaseDir);
        ...
        String currentPath=baseDir+userdir+"/"+typeStr;
